...
public class User {
    ...
    @Size(max = 25, message = "Email must be up to a maximum of 50 characters")
    private String email;

    @Pattern(regexp = "[7|8][0-9]{8}", message = "Phone Number must start with 7 or 8 and contain 8 digits")
    ...
    public User(
            ...
            @NotNull(message = "Email must be provided") @Email(message = "Must be a valid email") @Size(max = 25, message = "Email must be up to a maximum of 50 characters") String email,
            @Pattern(regexp = "[7|8][0-9]{8}", message = "Phone Number must start with 7 or 8 and contain 8 digits") String phoneno,
            String gender,
